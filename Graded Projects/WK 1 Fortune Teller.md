...
## Overview
As a Junior Developer you are being tasked with developing a console application. When complete, the application will provide the customer with their fortune based on data received from the customer.
...
- [ ] The application MUST ask the user to select a favorite color from the following colors: Red, Orange, Yellow, Green, Blue, Indigo, Violet.
	...
	- [ ] The 'Help' menu MUST be accessed by the user after entering 'Help'.
- [ ] The application MUST ask for the users number of siblings.
...
- [ ] The application MUST contain logic to calculate years until retirement based on the users age.
	- [ ] The application MUST calculate the years until retirement based on the following: even or odd years
- [ ] The application MUST choose a vacation home based on the numbers of siblings.  
	- [ ] The application MUST choose a vacation home based on the following criteria:
		- [ ] The application MUST choose a differant vacation home for each of the following numbers of siblings: '0', '1', '2', '3'.
...
- [ ] The application MUST choose a differant mode of transportation based on the choice of ROYGBIV color.
- [ ] The application MUST contain logic to calculate the amount of money in the bank based on the birth month.
	-[ ] The application MUST calculate the amount of money based on the following criteria:
		- [ ] The application MUST calculate a differant amount of money for birth months '1 - 4'.
		- [ ] The application MUST calculate a differant amount of money for birth months '5 - 8'.
		- [ ] The application MUST calculate a differant amount of money for birth months '9 - 12'
...
- [ ] The application MUST be able to process user inputs regadless of case.
- [ ] The application MUST use string concatenation to format the users fortune.

## Stretch Tasks:

During application development process, the following User interface(UI) requirements where identified. These requirements are not mandatory and are in no way a requirement for delivering the application.
